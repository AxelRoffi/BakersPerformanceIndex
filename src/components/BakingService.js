    ...
    <div>
      <Jumbotron>
        ...
        <p>
          ...
          all baking services already on the <Link to='/'>BPI list</Link> or not.<br />
          We will delegate <b>1000 XTZ</b> at <b>CYCLE 100</b> to each<br />
          baking service that needs to be on <Link to='/'>BPI list</Link>.<br />
          ...
          If you are a baking service, wether you already are<br /> on the <Link to='/'>BPI list</Link> or not,  and you want to be part of this new round of delegations<br />
